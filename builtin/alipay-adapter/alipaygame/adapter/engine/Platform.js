...
const ALIPAY_GAME = 113;
const OS_ANDROID = 'Android';
const OS_IOS = 'iOS';
const BROWSER_TYPE_ALIPAY_GAME = 'alipaygame';
const systemInfo = {};

// IIFE: initSystemInfo
(function () {
    var env = my.getSystemInfoSync();
    systemInfo.isNative = false;
    systemInfo.isBrowser = false;
    systemInfo.isMobile = true;
    systemInfo.platform = ALIPAY_GAME;
    ...
    systemInfo.browserType = BROWSER_TYPE_ALIPAY_GAME;
    ...
    var _supportWebGL = false, _supportWebp = false;
    try {
