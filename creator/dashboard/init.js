...
const { dirname: e, join: t } = require("fire-path"),
  { Tray: i, Menu: r, app: o } = require("electron"),
  { dashboardOpen: a, dashboardClose: n } = require("./lib/metrics"),
  { startup: d, closeAll: l, isEmpty: s } = require("./lib/editor"),
  {
    create: p,
    add: c,
    remove: E,
    check: h,
    getInfo: g
  } = require("../share/project"),
  u = require("../share/engine-utils"),
  f = require("../share/default-settings");
require("./lib/ipc"),
  require("../share/protocol/protocol-core"),
  (Editor.User = require("../share/user")),
  (Editor.versions.dashboard = "0.4.0"),
  (Editor.builtinCocosRoot = u.getEnginePath()),
...
(module.exports = function(e, i) {
  o.on("activate", () => {
    ...
    (Editor.requireLogin = 0 && !e.nologin),
    (Editor.testing = !!e.testing),
    Editor.testing && Editor.log("Running in testing environment"),
    (Editor.showInternalMount = Editor.dev && !!e.internal),
    Editor.Profile.register("global", Editor.App.home),
    Editor.log("Load ~/.CocosCreator/settings.json"),
    (Editor.App._profile = Editor.Profile.load(
      "profile://global/settings.json",
      f
    )),
    Editor.Profile.setDefault("profile://global/updates.json", {
      "received-ids": [],
      "installed-hotupdates": []
    });
  let r = Editor.App._profile.data;
  if (
    ((Editor.lastLogin = r["last-login"]),
    Editor.log("checking language setting..."),
    "en" === r.language || "zh" === r.language)
  )
    Editor.lang = r.language;
  else {
    let e = o.getLocale();
    e && e.includes("zh")
      ? (Editor.lang = r.language = "zh")
      : (Editor.lang = r.language = "en"),
  ...
  Editor.log(`Language: ${Editor.lang}`),
    ...
    Editor.Package.removePath(
      t(Editor.App.path, Editor.dev ? "" : "..", "builtin")
    );
  ...
  Editor.App.extend({
    ...
    createProject: function(t, i) {
      ...
      (Editor.App._profile.data["last-create"] = t.path),
        Editor.App._profile.save(),
        this.updateLastCreatePath(e(t.path)),
        p(t.path, t.template, i);
    },
    updateLastCreatePath(e) {
      (Editor.App._profile.data["last-create-path"] = e),
        Editor.App._profile.save();
    },
    addProject(e) {
      c(e);
    ...
    run() {
      new Promise((e, t) => {
        require("../share/network").canConnectPassport(function(t) {
          (Editor.isOffline = !t),
            Editor.isOffline && (Editor.requireLogin = 0 && !1),
            e();
        });
      })
        .then(() => {
          ...
          "darwin" === process.platform &&
            (delete e.frame, (e.titleBarStyle = "hiddenInset")),
        ...
        .then(() => {
          (m = new i(Editor.url("app://dashboard/static/tray.png"))).setToolTip(
            "Cocos Creator"
          ),
            m.on("click", () => {
              Editor.Window.main &&
